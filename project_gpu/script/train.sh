...
# Hyperparameters
dataset_array=("eth" "hotel" "univ" "zara1" "zara2" "nuscene")
device_id_array=(0 1 2 3 4 5)
tag="EigenTrajectory"
config_path="./config/"
...
do
  ...
  CUDA_VISIBLE_DEVICES=${device_id_array[$i]}
  python trainval.py --cfg "${config_path}""${config_prefix}"-"${baseline}"-"${dataset_array[$i]}".json \
